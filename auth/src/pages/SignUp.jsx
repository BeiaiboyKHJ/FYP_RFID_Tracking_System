...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f6efe9] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white/90 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-[#e6d8c8]">
              ...
              <button
                ...
                className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white ${
                  loading
                    ...
                    : 'bg-[#1d6b62] hover:bg-[#14524c] focus:ring-[#1d6b62]'
